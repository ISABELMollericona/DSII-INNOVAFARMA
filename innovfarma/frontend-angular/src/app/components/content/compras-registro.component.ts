...
@Component({
  ...
  template: `
    <div class="container-fluid">
      <h2 class="mb-3">Registro de Compra</h2>
      <div class="card">
        <div class="card-header bg-primary text-white">
          <h5 class="mb-0">Ingresos de Mercadería</h5>
        </div>
        <div class="card-body">
          <button class="btn btn-success me-2"><i class="bi bi-plus-lg"></i> Nueva Compra</button>
